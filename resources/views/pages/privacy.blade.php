        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p>Az adatok törléséről az oldal alján található "Fiók megszüntetése és adatok törlése" szekció ad bő megfelelő iránymutatást.</p>
        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <button class="btn btn-danger" data-toggle="modal" data-target="#delete-modal">Fiókom és személyes adataim törlése</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Fiók és személyes adatok törlése</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                Biztosan törölni akarod a fiókodat és a személyes adataidat? Ezt nem lehet visszavonni!
            </div>
            <div class="modal-footer">
                ...
                <form action="{{ route('deleteuser') }}" method="POST">
                    @csrf
                    @method('delete')
                    <button type="submit" id="delete-modal-delete-button" class="btn btn-danger">Törlés</button>
                </form>
            </div>
        </div>
    </div>
